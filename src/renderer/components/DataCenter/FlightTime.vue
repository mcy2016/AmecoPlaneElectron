...
<style rel="stylesheet">
    ...
    .flight-time .export-table {
        float: right;
        bottom: 5px;
    }
    .flight-time .el-table thead {
        color: #ffffff;
        font-size: larger;
    }
    .flight-time .el-table .cell, .el-table th > div {
        text-align: center;
        /*margin-left: 10px;*/
    }
    .flight-time .el-table thead tr {
        color: #000000;
        font-size: larger;
    }

    .flight-time .el-table tbody tr {
        color: #000;
        font-size: larger;
    }

    .flight-time .el-table tbody tr td {
        padding: 2px 0;
    }
